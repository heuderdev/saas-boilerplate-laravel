<x-layouts::auth :title="__('Register')">
    <div class="flex flex-col gap-6">
        ...
        <form method="POST" action="{{ route('register.store') }}" class="flex flex-col gap-6">
            @csrf
            <flux:input name="company_name" :label="__('Nome da Empresa')" type="text" :value="old('company_name')"
                required autofocus autocomplete="organization" :placeholder="__('Sua Empresa Ltda')" />
